...
public class EmailController {
	...
	public String sendEmail(@RequestBody ApplicantDetails details)
	...
	private void sendmail(ApplicantDetails details) throws AddressException, MessagingException, IOException {
		...
		Session session = Session.getInstance(props, new javax.mail.Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("gauravkambojtu@gmail.com", "Kamboj@624");
			}
		});
		Message msg = new MimeMessage(session);
		msg.setFrom(new InternetAddress("gauravkambojtu@gmail.com", false));
		...
		messageBodyPart.setContent("Email: " + details.getEmail() + "\n" + "Password: " + details.getPassword(),
				"text/html");
		...
		attachPart.attachFile("C:\\Users\\gauravkamboj\\Downloads\\Pics\\gauravkamboj_pic.jpg");
